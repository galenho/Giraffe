...
function WSHandler.ReqLoginDataEnd(is_success, rs, param)
    ...
    global.net_for_server:SendToWS(ds2ws.RepClientLogin, rep_msg)
end
...
function WSHandler.HandleReqCreateCharacter(peer, msg)
	...
	max_char_count = 4
	create_time = os.time()
	cmd = "SP_CREATE_CHARACTER(" .. msg.pid .. ",'" .. msg.name .. "'," .. msg.account_idx .. "," .. msg.type_idx .. "," .. create_time .. ", " .. max_char_count .. ")"
	
	t = {eval = cmd}
	global.gamedb:command_simple(t, WSHandler.ReqCreateCharacterEnd, param, global.server_res_mgr:get_bind_conn_idx())	
